            ...
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse my-4" aria-labelledby="headingTwo" data-parent="#accordion">
                    ...
                    <div class="form-group row">
                        <label for="text1" class="col-3 col-form-label">Name</label>
                        <div class="col-9">
                            <input id="text1" name="co_applicant_name" type="text" class="form-control">
...
{{--        @endif--}}
        ...
        <div class="form-group row">
          <label for="text1" class="col-3 col-form-label">Name</label>
          <div class="col-9">
            <input id="text1" name="guarantor_name" type="text" class="form-control">
            ...
            <div class="card">
                ...
                <div id="collapseThree" class="collapse my-4" aria-labelledby="headingThree" data-parent="#accordion">
                    <div class="form-group row">
                        <label for="text1" class="col-3 col-form-label">Name</label>
                        <div class="col-9">
                            <input id="text1" name="second_guarantor_name" type="text" class="form-control">
